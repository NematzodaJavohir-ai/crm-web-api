...
public interface IAttendanceRepository
{
    ...
    Task<int> GetPresentCountByWeekAsync(int studentId, int groupId, int weekNumber, CancellationToken ct = default);
    Task<int> GetAbsenceCountAsync(int studentId, int groupId, CancellationToken ct = default);
    Task<double> GetAttendanceRateAsync(int studentId, int groupId, CancellationToken ct = default);
}
