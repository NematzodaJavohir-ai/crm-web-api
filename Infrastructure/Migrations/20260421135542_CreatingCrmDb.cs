...
{
    /// <inheritdoc />
    public partial class CreatingCrmDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialUrl = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<int>(type: "integer", nullable: false),
                    WeekNumber = table.Column<int>(type: "integer", nullable: false),
                    BonusScore = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    ExamScore = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsenceReason = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    MentorNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    HomeworkDone = table.Column<bool>(type: "boolean", nullable: false),
                    HomeworkScore = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Teacher/Mentor with course management access", "Mentor" },
                    { 3, "Regular user/Student", "Student" }
                });
